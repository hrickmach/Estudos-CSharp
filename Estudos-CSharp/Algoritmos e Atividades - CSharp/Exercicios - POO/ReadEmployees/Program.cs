using System;
using ReadEmployees.Entities;
using System.IO;
using System.Globalization;
using System.Linq;
using System.Collections.Generic;

namespace ReadEmployees
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Sum of salary of whose name starts with 'M': " + sum.ToString("F2", CultureInfo.InvariantCulture));
            }
            catch (IOException e)
            {
